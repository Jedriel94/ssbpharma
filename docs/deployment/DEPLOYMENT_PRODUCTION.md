...
define('DB_NAME', 'solumedic_dbshop'); // O el nombre final que definas en producción
...
- `docs/archive/root-historico/SOLUCION_404_PRODUCCION.md` - Histórico de errores comunes
